...
\newpage
# Desarrollo
```{r eval=FALSE, message=FALSE, warning=FALSE,out.width="80%"}
#Por si no contamos con las librerías
# Primero instalar pacman si no está
if(!require(pacman)) install.packages("pacman")

# Luego usar p_load para instalar/cargar todo
pacman::p_load(dplyr, ggplot2, sf, gstat, caret, tidyr, reshape2, 
               geoR, spatstat, tidyverse)
```
